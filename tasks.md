...
| [x] Add task status updates, comments, and completion flow | Developer 2 | `feature/task-status-updates` | Staff task dashboard |
| [x] Add overdue task indicators and filters | Developer 1 | `feature/task-overdue-filters` | Task status updates |
| [x] Link tasks to workflow stages and client profile | Developer 2 | `feature/task-client-linking` | Client profile, task model |
